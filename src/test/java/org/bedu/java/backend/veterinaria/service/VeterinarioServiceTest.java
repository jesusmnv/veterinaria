...
class VeterinarioServiceTest {
    ...
    void findAllTest(){
        ...
        try {
            veterinario.setFechaNacimiento(new SimpleDateFormat("yyyy-MM-dd").parse("1990-01-24"));
    ...
    void saveTest(){
        ...
        // Checa si el Veterinario modelo tiene los mismos valores que el DTO de CreateDTOVeterinario
